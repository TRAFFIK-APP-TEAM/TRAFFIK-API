...
namespace TRAFFIK_API.Migrations
{
    ...
    [Migration("20251005092800_AddCarTypeAndServicesOffered")]
    partial class AddCarTypeAndServicesOffered
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TRAFFIK_API.Models.CarType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("TRAFFIK_API.Models.Booking", b =>
                {
                    b.HasOne("TRAFFIK_API.Models.CarModel", null)
                        .WithMany("Bookings")
                        .HasForeignKey("CarModelId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("TRAFFIK_API.Models.ServiceCatalog", null)
                        .WithMany("Bookings")
                        .HasForeignKey("ServiceCatalogId");

                    b.HasOne("TRAFFIK_API.Models.User", null)
                        .WithMany("Bookings")
